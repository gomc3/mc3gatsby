        ...
        <div className='w-4/5  mx-auto rounded-md border border-gray-500 p-3 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4'>
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Luigi Laugelli</h3>
              <h4 className='text-sm '>Co-chair</h4>
              <p className='hidden'>
                <a href='https://www.linkedin.com/'>
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Michael Ballone</h3>
              <h4 className='text-sm '>Co-chair</h4>
              <p className='hidden'>
                <a href='https://www.linkedin.com/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Christine Formica</h3>
              <h4 className='text-sm '>Recording Secretary</h4>
              <p>
                <a href='https://www.linkedin.com/in/christine-formica-6b72127b/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
                  <span className='ml-2 text-xs'>Connect on LinkedIn</span>
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Sarah Poppe Seeley</h3>
              <h4 className='text-sm '>Recording Secretary</h4>
              <p className='hidden'>
                <a href='https://www.linkedin.com/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Melanie Harding</h3>
              <h4 className='text-sm '>Treasurer</h4>
              <p className='hidden'>
                <a href='https://www.linkedin.com/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
                  <span className='ml-2 text-xs'>Connect on LinkedIn</span>
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Neil Mastroianni</h3>
              <h4 className='text-sm '>Technology Consultant</h4>
              <p>
                <a href='https://www.linkedin.com/in/nmastroianni/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
                  <span className='ml-2 text-xs'>Connect on LinkedIn</span>
      ...
      <section className='mt-6 py-6 bg-blue-50'>
        ...
        <div className='w-4/5  mx-auto rounded-md border border-gray-500 p-3 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4'>
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Kelly Weldon</h3>
              <h4 className='text-sm '>Co-chair</h4>
              <p>
                <a href='https://www.linkedin.com/in/kelly-weldon-3477654a/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Matt Kukoda</h3>
              <h4 className='text-sm '>Co-chair</h4>
              <p>
                <a href='https://www.linkedin.com/in/matt-kukoda-276b7b167/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Cheryl Romano</h3>
              <h4 className='text-sm '>Recording Secretary</h4>
              <p className='hidden'>
                <a href='https://www.linkedin.com/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Tara Micciulla</h3>
              <h4 className='text-sm '>Recording Secretary</h4>
              <p className='hidden'>
                <a href='https://www.linkedin.com/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Chris Alworth</h3>
              <h4 className='text-sm '>Technology Consultant</h4>
              <p>
                <a href='https://www.linkedin.com/in/chrisalworth'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
        ...
        <div className='w-4/5  mx-auto rounded-md border border-gray-500 p-3 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4'>
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Erica Reynolds</h3>
              <h4 className='text-sm '>Co-chair</h4>
              <p className='hidden'>
                <a href='https://www.linkedin.com/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Mark Guterl</h3>
              <h4 className='text-sm '>Co-chair</h4>
              <p>
                <a href='https://www.linkedin.com/in/mark-guterl-64a88261/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Kelly Harmon</h3>
              <h4 className='text-sm '>Recording Secretary</h4>
              <p className='hidden'>
                <a href='https://www.linkedin.com/in/kelly-harmon-75a4481a/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Marc Natanagara, Ed.D.</h3>
              <h4 className='text-sm '>Ocean County Chair</h4>
              <p>
                <a href='https://www.linkedin.com/in/marcnatanagara64/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
                  <span className='ml-2 text-xs'>Connect on LinkedIn</span>
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Michael Liebmann</h3>
              <h4 className='text-sm '>Treasurer</h4>
              <p className='hidden'>
                <a href='https://www.linkedin.com/in/mike-liebmann-aa369ab6/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
        ...
        <div className='w-4/5  mx-auto rounded-md border border-gray-500 p-3 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4'>
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Karen Barry</h3>
              <h4 className='text-sm '>Co-chair</h4>
              <p className='hidden'>
                <a href='https://www.linkedin.com/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>John Bombardier</h3>
              <h4 className='text-sm '>Co-chair</h4>
              <p className='hidden'>
                <a href='https://www.linkedin.com/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Jennifer Donnelly</h3>
              <h4 className='text-sm '>Recording Secretary</h4>
              <p>
                <a href='https://www.linkedin.com/in/jennifer-donnelly-152133a9/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Dara Van Pelt</h3>
              <h4 className='text-sm '>Treasurer</h4>
              <p className='hidden'>
                <a href='https://www.linkedin.com/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Lauren Basselini</h3>
              <h4 className='text-sm '>Technology Consultant</h4>
              <p>
                <a href='https://www.linkedin.com/in/lauren-b-4695b436/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
          ...
          <div className='p-4 flex flex-wrap items-center'>
            ...
            <div className='flex-1'>
              <h3 className='text-xl font-medium'>Tom Semko</h3>
              <h4 className='text-sm '>Technology Consultant</h4>
              <p>
                <a href='https://www.linkedin.com/in/thomas-semko-82219411/'>
                  <FaLinkedin className='inline text-blue-700 text-sm' />
