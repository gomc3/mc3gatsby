                      ...
                      <div>
                        ...
                        {item.description ? (
                          <>
                            ...
                            <p
                              className="text-xs sm:text-sm event-description"
                        ...
                        {item.attachments ? (
                          <ul className="flex flex-wrap justify-center my-6 sm:my-3 space-x-0 sm:space-x-2 lg:space-x-3 space-y-6 sm:space-y-0">
                            {item.attachments.map((file) => {
                              return (
                                <a
                                  ...
                                  href={file.fileUrl}
                                  title={file.title}
                                  className="px-3 py-2 bg-gray-200 hover:bg-gray-300 rounded-md text-gray-800 hover:text-black flex-0"
                                >
                                  <li className="">
